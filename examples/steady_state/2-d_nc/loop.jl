...
plot!(0:n, lagrange_errors1, label = "P1 LM", line = (3, :solid), dpi=1000, palette=:lighttest, markershape=[:diamond])
savefig("SinXSinYRefinement.pdf")
...
# plot(0:n, L2_errors1, title=L"$L^2$ Error vs Refinement Level ", xlabel=L"Refinement Level $r$", ylabel="Error", yscale=:log10, label = "Temperature", line = (3, :dash), dpi=1000, palette=:lighttest,legend=:bottomleft, markershape=[:rect :cross])
...
# plot!(0:n, lagrange_errors1, label = "P0 LM", line = (3, :solid), dpi=1000, palette=:lighttest, markershape=[:circle :diamond])
# savefig("P0P2_QuadRefinement.pdf")
...
# plot(0:n, L2_errors1, title=L"$L^2$ Error vs Refinement Level ", xlabel=L"Refinement Level $r$", ylabel="Error", yscale=:log10, label = ["Temperature (P0 LM)" "Temperature (P2 LM)"], line = (3, :dash), dpi=1000, palette=:lighttest,legend=:bottomleft, markershape=[:rect :cross])
# # plot!(0:n, lagrange_errors0, label = "P0 LM", line = (3, :solid), dpi=1000, palette=:lighttest)
# # plot!(0:n, L2_errors1, label = "Temperature (Quad)", line = (3, :dash), dpi=1000)
# plot!(0:n, lagrange_errors1, label = ["P0 LM" "P2 LM"], line = (3, :solid), dpi=1000, palette=:lighttest, markershape=[:circle :diamond])
# savefig("curvedRefinement.pdf")
...
# # plot!(0:n, L2_errors1, label = "Temperature (Quad)", line = (5, :dash), dpi=1000)
# plot!(0:levels, lagrange_errors, label = ["P0 LM" "P1 LM"], line = (3, :solid), dpi=1000, palette=:lighttest, markershape=[:circle :diamond])
# savefig("WohlmuthRefinement_lc.pdf")
