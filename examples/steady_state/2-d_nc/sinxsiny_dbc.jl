...
dbc_nodes1 = sort(unique([selectnode(fens1; box=boxleft, inflate=1e-8)
                ; selectnode(fens1; box=boxright, inflate=1e-8)
                ; selectnode(fens1; box=boxtop, inflate=1e-8)
                ; selectnode(fens1; box=boxbot, inflate=1e-8) ]))
...
dbc_nodes2 = sort(unique([selectnode(fens2; box=boxleft, inflate=1e-8)
                ; selectnode(fens2; box=boxright, inflate=1e-8)
                ; selectnode(fens2; box=boxtop, inflate=1e-8)
                ; selectnode(fens2; box=boxbot, inflate=1e-8) ]))
for i in dbc_nodes2
